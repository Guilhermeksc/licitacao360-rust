use druid::{Env, Menu, MenuItem, LocalizedString, Data, WindowId, Selector};
...
const MENU_INFOGRAFICOS: Selector = Selector::new("menu-infograficos");
const MENU_UTILITIES: Selector = Selector::new("menu-utilities");
const MENU_ABOUT: Selector = Selector::new("menu-about");

use crate::AppState;

pub fn build_menu<T: Clone + Data>(_id: Option<WindowId>, _state: &AppState, _env: &Env) -> Menu<T> {
    ...
    let infograficos_menu = Menu::new(LocalizedString::new("Infográficos"))
        .entry(MenuItem::new(LocalizedString::new("Infográficos")).command(MENU_INFOGRAFICOS));
