...
#[derive(Clone, Debug)]
pub struct DispensaEletronicaData {
...
impl DispensaEletronicaData {
    pub fn new() -> Self {
        DispensaEletronicaData {
            numero: None,
            ano: None,
            id_processo: None,
            nup: None,
    ...
    pub fn load_or_create(paths: &Paths) -> DataFrame {
        load_or_create(paths, "dispensa_eletronica.parquet", vec![
    ...
    pub fn save_to_parquet(&self, paths: &Paths) -> Result<(), PolarsError> {
        ...
        let file = File::create(paths.dispensa_eletronica_parquet_path())?;
